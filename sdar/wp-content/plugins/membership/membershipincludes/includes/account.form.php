	...
	<fieldset>
		<legend><?php _e( 'Edit your details', 'membership' ) ?></legend>
			...
			<div class="form-element">
				...
				<div class="element">
					<input type="text" class="input-xlarge" id="user_login" name="user_login" placeholder="" value="<?php echo esc_attr($profileuser->user_login); ?>" disabled="disabled" >
			...
			<div class="form-element">
				...
				<div class="element">
					<input type="text" class="input-xlarge" name="email" id="email" value="<?php echo esc_attr($profileuser->user_email) ?>" />
                        ...
                        <div class="form-element">
				<label class="control-label" for="url"><?php _e('Representative Name', 'membership'); ?></label>
				<div class="element">
					<input type="text" class="input-xlarge" name="mlsname" id="mlsname" value="<?php echo esc_attr($profileuser->mlsname) ?>" />
				</div>
			</div>

                        <div class="form-element">
				<label class="control-label" for="url"><?php _e('Representative Member ID', 'membership'); ?></label>
				<div class="element">
					<input type="text" class="input-xlarge" name="mlsid" id="mlsid" value="<?php echo esc_attr($profileuser->mlsid) ?>" />
				</div>
			</div>
			...
			<div class="form-element">
				...
				<div class="element">
					<input type="password" class="input-xlarge" name="pass2" id="pass2" value="" autocomplete="off" />
                        ...
                        <input type="hidden" value="false" class="form-valid">
                        <p class="mls-error" style="color:red;text-align:center;"></p>
        ...
        method: "POST"
         ...
         if (results.length == 1) {
          ...
          $('.form-membership').submit();
           ...
           $('.mls-error').text("Sorry, your representative name and ID do not match our records.");
         }
      });
    }
  });
